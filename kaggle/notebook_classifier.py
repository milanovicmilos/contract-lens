...
# ---------------------------------------------------------------------------
# 1. Install dependencies (Kaggle base has torch + transformers already)
# ---------------------------------------------------------------------------
def _ensure_deps():
    import subprocess
    for pkg in ("peft>=0.10.0", "scikit-learn>=1.3.0"):
...
DATASET_PATH = "/kaggle/input/contractlens-cuad-multilabel/cuad_multilabel.jsonl"
...
def main():
    ...
    if not os.path.exists(DATASET_PATH):
        raise FileNotFoundError(
            ...
            "Ensure the Kaggle dataset 'contractlens-cuad-multilabel' is attached."
        )
